...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.create_table(u'flatpages_flatpage', (
            ...
            ('date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2015, 3, 17, 0, 0))),
    ...
    models = {
        u'flatpages.flatpage': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 3, 17, 0, 0)'}),
